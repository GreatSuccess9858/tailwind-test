...
const Homepage = () => {
  return (
    <div id="promotion">
      ...
      <div className="flex flex-col items-center justify-start font-sans min-h-96 bg-gray-50 lg:pt-10 lg:pb-20 lg:bg-cover">
        {/* <div>
        ...
        <div>
          <p className="p-2 text-4xl font-bold text-blue-800 lg:mx-auto lg:w-4/6 lg:text-5xl lg:text-gray-100">
            {/* {tagLine} */}
          </p>
        </div>
        <div>
