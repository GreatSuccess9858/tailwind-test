...
const Footer = ({ logo }) => {
  return (
    <div id="contact" className=" bg-black py-10 px-24">
        ...
        <div className="flex items-center justify-around w-2/3 pt-5 lg:pt-0 lg:w-1/3 ">
          <div className="flex flex-col px-16 py-12 bg-gray-800 gap-2 rounded-3xl" style={{ background: '#283343' }}>
            <div className="flex justify-center items-start gap-8">
              ...
              <div className=" text-white font-sans text-xl font-bold leading-9 capitalize">Platforms
                <div className=" font-sans text-lg font-semibold leading-9 text-gray-500">
                  iOS
                </div>
                <div className=" font-sans text-lg font-semibold leading-9 text-gray-500">
                  Android
      ...
      <div className=" flex flex-row flex-wrap justify-between text-lg text-gray-300 lg:mt-0 mt-16">
        <div className=" pt-16">
          Due Diligenze © 2023. All rights reserved by Bassantovs LLC
        </div>
        <div className=" font-sans text-lg font-semibold pt-16">
          Cookies / Sales / Terms of Service / Privacy
        </div>
      </div>
    </div>
  );
